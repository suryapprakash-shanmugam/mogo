                ...
                <Menu classNames='table-selectbox'>
                    ...
                    <Menu.Dropdown>
                        <Menu.Item onClick={openDeleteModal}>
                            <img src={check} alt='check icon' width={15} />&nbsp;&nbsp; Approve
                        </Menu.Item>
                        <Menu.Item onClick={openDeleteModal}>
            ...
            <div className="product-comments-div">
                ...
                <Card className="product-comments-div-card">
                    <div className="product-comments-div-card-heading">
                        ...
                        <Text component={Link} to="/approved_blog_comments"><button><img src={list} width={12} alt="list icon" />Approved Comments</button></Text>
                    </div>
...
export default PendingBlogComments