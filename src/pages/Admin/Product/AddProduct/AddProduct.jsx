...
const AddProduct = () => {
  ...
  const showProductTagsArray = [{ tags: "electronics" }, { tags: "mobiles" }];
  ...
  // useReact Query
  useQuery("Products", listAllProduct, {
  ...
  const previewsGalleryProduct = multiProductImage?.map((image, index) => {
    ...
    return (
      <Indicator
        ...
        label={
          <X
            onClick={() => removeMultiProductImage(index)}
  ...
  useQuery("categoryList", categoryListAPI, {
    ...
    onSuccess: (res) => {
      setCategoryDetails({
        ...categoryDetails,
        category: res.data.data.result,
      });
    },
  });

  useQuery(
    ["subCategoryList", productDetails.product_category],
    subCategoryListByCategoryID,
    {
      ...
      onSuccess: (res) => {
        setCategoryDetails({
          ...categoryDetails,
          subCategory: res.data.data.result,
        });
      },
    }
  );
        ...
        <div className="add-product-div-container">
          <div className="add-product-div-container-left">
            <div className="add-product-div-container-left-product-name">
              <Input.Wrapper
                error={`${
                  validateProductField.product_name === 1
              ...
              <div className="add-product-div-container-left-product-data-card">
                <div className="add-product-div-container-left-product-data-card-heading">
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      setProductDetails({ ...productDetails, product_type: e })
                    }
                  />
                </div>
                <div className="add-product-div-container-left-product-data-card-tab">
                  {productDetails.product_type === "simple" ? (
                    ...
                    >
                      ...
                      <Tabs.Panel
                        className="add-product-div-container-left-product-data-card-tab-panel"
                        value="general"
                      >
                        <div className="add-product-div-container-left-product-data-card-tab-panel-grid">
                          ...
                          <Input.Wrapper
                            error={`${
                              validateProductField.actual_price === 1
                        ...
                        <div className="add-product-div-container-left-product-data-card-tab-panel-grid grid-last">
                          ...
                          <Input.Wrapper
                            error={`${
                              validateProductField.sale_price === 1
                        ...
                        {productDetails.tax_status == "taxable" ? (
                          <>
                            <div className="add-product-div-container-left-product-data-card-tab-panel-grid">
                              ...
                              <Input.Wrapper
                                error={`${
                                  validateProductField.tax_type === 1
                            ...
                            {productDetails.tax_type ? (
                              <div className="add-product-div-container-left-product-data-card-tab-panel-grid">
                                ...
                                <Input.Wrapper
                                  error={`${
                                    validateProductField.tax_rate === 1
                          ...
                          >
                            <Checkbox
                              ...
                              onChange={(e) => {
                                ...
                                setStockManagement(e.currentTarget.checked);
                              }}
                            />
                          </Input.Wrapper>
                        </div>
                        {stockManagement === true ? (
                          <div>
                            <div className="add-product-div-container-left-product-data-card-tab-panel-grid">
                              ...
                              <Input.Wrapper
                                error={`${
                                  validateProductField.initial_quantity === 1
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          ...
                          className="add-product-div-container-left-product-data-card-tab-panel-grid-schedule"
                        >
                          {schedule === true ? "Cancel" : "Schedule"}
                        </p>
                        <div className="hr-line mt-10" />
                        <div className="add-product-div-container-left-product-data-card-tab-panel-grid">
                          <label>Tax status</label>
                      ...
                      >
                        ...
                        <div className="add-product-div-container-left-product-data-card-tab-panel-grid">
                          ...
                          <Checkbox
                            ...
                            size="xs"
                            onChange={(event) =>
                              setSoldIndividual(event.currentTarget.checked)
                            }
                          />
                        </div>
                        <div className="hr-line mt-10" />
                            ...
                            <Accordion variant="separated">
                              <Accordion.Item value="value">
                                ...
                                <Accordion.Panel>
                                  ...
                                  <div className="hr-line mt-10" />
                                  <button className="save-attributes-button">
                                    Save attributes
                                  </button>
                                </Accordion.Panel>
                              </Accordion.Item>
                        ...
                        <div className="add-product-variations">
                          <div className="add-product-variations-head">
                            ...
                            <button
                              ...
                              onClick={addAccordionVariationItem}
                            >
                              Add manually
                            </button>
                          </div>
                                  ...
                                  <Accordion.Control
                                    icon={
                                      <span
                                        className="remove-accordion-button"
                                        onClick={() =>
                                          removeAccordionVariationItem(index)
                                        }
                                      >
                                        Remove
                                      </span>
                                        ...
                                        <div className="accordionvariation-content-form-fields">
                                              ...
                                              <>
                                                <div className="variation-field-hide">
                                                  ...
                                                  <DatePicker
                                                    ...
                                                    onChange={
                                                      handleStartDateChangeVariation
                                                    }
                                                    minDate={new Date()}
                                                  />
                                                </div>
                                          ...
                                          <div className="accordionvariation-content-form-fields-individual-full">
                                            ...
                                            <Select
                                              ...
                                              onChange={
                                                handlevariationStockClassChange
                                              }
                                            />
                                          </div>
                                          <div className="accordionvariation-content-form-fields-individual-full">
                                          ...
                                          <div className="hr-line mt-10" />
                                          <button className="accordionvariation-content-form-btn">
                                            Save changes
                                          </button>
                                        </div>
                                      </div>
                ...
                <div className="add-product-div-container-right-product-image-card-content">
                  {productSingleImage ? (
                    <div className="add-product-div-container-right-product-image-card-content-image">
                      <AspectRatio ratio={300 / 300} maw={300} mx="auto">
            ...
            <div className="add-product-div-container-right-product-gallery">
              <Card className="add-product-div-container-right-product-gallery-card">
                ...
                <div className="add-product-div-container-right-product-gallery-card-content">
                  <span
                    onClick={handleMultiProductImage}
                    className="product-add"
                  >
            ...
            <div className="add-product-div-container-right-product-tags">
              <Card className="add-product-div-container-right-product-tags-card">
                ...
                <div className="add-product-div-container-right-product-tags-card-content">
                  ...
                  <p className="add-product-div-container-right-product-tags-card-content-para">
