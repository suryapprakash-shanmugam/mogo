...
const SpecialProducts = () => {
        ...
        },
        {
            ...
            accessor: (() => <div>
                <Menu classNames='table-selectbox'>
                    ...
                    <Menu.Dropdown>
                        <Text component={Link} to="/specialproductsdetails_individual">
                            <Menu.Item>
    ...
    return (
        <div>
            <div className="specialproducts-div">
                <Card>
                    <div className="specialproducts-div-heading">
                        <h2>Special Products</h2>
                    </div>
                    <div className="specialproducts-div-table">
                        <div>
                            <div className='specialproducts-filter-container'>
                                <div className='specialproducts-filter-container-div1'>
                                    <Select
                                        label='Show'
                                ...
                                <div className='specialproducts-filter-container-div2'>
                                    <Select
                                        label='Category'
                                ...
                                <div className='specialproducts-filter-container-div3'>
                                    <Select
                                        label='Sub Category'
                                ...
                                <div className='specialproducts-filter-container-div5'>
                                    <Select
                                        label='Stock'
                                ...
                                <div className='specialproducts-filter-container-div4'>
