...
const Products = () => {
    ...
    const handlespecialOffers = () => {
        setSpecialOffers((prevSpecialOffers) => !prevSpecialOffers);
    };
    
    const handlefeaturedOffers = () => {
        setFeaturedOffers((prevFeaturedOffers) => !prevFeaturedOffers);
    };
                ...
                <Menu classNames='table-selectbox'>
                    ...
                    <Menu.Dropdown>
                        ...
                        <Menu.Item onClick={() => { setFeaturedModalOpen(true) }}>
                            <img src={plusfilled} alt='check icon' width={15} />&nbsp;&nbsp;Add to Featured
                        </Menu.Item>
                        <Menu.Item onClick={handlespecialOffers}>
                            <img src={plusfilled} alt='block icon' width={15} />&nbsp;&nbsp;{specialOffers === true ? 'Remove From Special Offers' : 'Add to Special Offers'}
                        </Menu.Item>
