...
const HiddenProducts = () => {
        ...
        },
        {
            ...
            accessor: (() => <div>
                <Menu classNames='table-selectbox'>
                    ...
                    <Menu.Dropdown>
                        <Text component={Link} to="/hiddenproductsdetails_individual">
                            <Menu.Item>
    ...
    return (
        <div>
            <div className="hiddenproducts-div">
                <Card>
                    <div className="hiddenproducts-div-heading">
                        <h2>Hidden Products</h2>
                    </div>
                    <div className="hiddenproducts-div-table">
                        <div>
                            <div className='hiddenproducts-filter-container'>
                                <div className='hiddenproducts-filter-container-div1'>
                                    <Select
                                        label='Show'
                                ...
                                <div className='hiddenproducts-filter-container-div2'>
                                    <Select
                                        label='Category'
                                ...
                                <div className='hiddenproducts-filter-container-div3'>
                                    <Select
                                        label='Sub Category'
                                ...
                                <div className='hiddenproducts-filter-container-div5'>
                                    <Select
                                        label='Stock'
                                ...
                                <div className='hiddenproducts-filter-container-div4'>
