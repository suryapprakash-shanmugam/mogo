  ...
  return (
    <div>
      <div className="featuredproducts-div">
        <Card>
          <div className="featuredproducts-div-heading">
            <h2>Featured Products</h2>
          </div>
          <div className="featuredproducts-div-table">
            <div>
              <div className='featuredproducts-filter-container'>
                <div className='featuredproducts-filter-container-div1'>
                  <Select
                    label='Show'
                ...
                <div className='featuredproducts-filter-container-div2'>
                  <Select
                    label='Category'
                ...
                <div className='featuredproducts-filter-container-div3'>
                  <Select
                    label='Sub Category'
                ...
                <div className='featuredproducts-filter-container-div5'>
                  <Select
                    label='Stock'
                ...
                <div className='featuredproducts-filter-container-div4'>
